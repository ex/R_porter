...
Begin VB.Form frmExDynaEdit 
   ClientHeight    =   3855
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   5055
   Icon            =   "frmExDynaEdit.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   3855
   ScaleWidth      =   5055
   ...
   End
End
Attribute VB_Name = "frmExDynaEdit"
...
Private Sub mnuSave_Click()
    ...
    On Error GoTo Handler
    If vbNo = MsgBox("¿Estas seguro de guardar los cambios?", vbQuestion + vbYesNo, "Confirmar actualizacion") Then
        Exit Sub
    End If
    With flxResults
        Dim k As Integer
...
Handler: MsgBox "No se pudo actualizar el registro." & vbCrLf & "Posibles causas de error:" & vbCrLf & _
